    ...
    try {
      const { userId, credits, s3Key } = await step.run(
        ...
        async () => {
          ...
          console.log("S3 Key for uploaded file:", uploadedFile.s3Key);
      ...
      if (credits > 0) {
        ...
        const { clipsFound } = await step.run(
          ...
          async () => {
            ...
            console.log("Found clip keys:", clipKeys);
        ...
        console.log("Clips found and counted:", clipsFound);
