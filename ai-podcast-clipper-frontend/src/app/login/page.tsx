      ...
      <div className="relative flex flex-col md:flex-row w-full max-w-5xl rounded-xl shadow-2xl overflow-hidden bg-white/80 backdrop-blur-md">
        ...
        <div className="w-full md:w-1/2 p-8 flex items-center justify-center">
          <div className="w-full max-w-sm">
            <h2 className="text-3xl font-bold tracking-tight text-center text-gray-900 mb-6 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 bg-clip-text text-transparent font-cursive">
              Welcome
            </h2>
            <LoginForm />
          </div>
